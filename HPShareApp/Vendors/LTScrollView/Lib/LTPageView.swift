...
let SELECT_BASE_COLOR: UIColor = UIColor(r: 0, g: 0, b: 0)
...
public class LTLayout: NSObject {
    ...
    /* pageView底部线的高度 */
    @objc public var pageBottomLineHeight: CGFloat = 1.0
    
    /* pageView底部线的颜色 */
    @objc public var pageBottomLineColor: UIColor? = UIColor(r: 238, g: 238, b: 238)
