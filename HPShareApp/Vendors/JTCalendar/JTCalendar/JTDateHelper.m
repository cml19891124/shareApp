...
- (BOOL)date:(NSDate *)dateA isBeforeMonthOf:(NSDate *)dateB {
    NSDate *firstDate = [self firstDayOfMonth:dateB];
    
    if ([self date:dateA isBefore:firstDate]) {
        return YES;
    }
...
- (BOOL)date:(NSDate *)dateA isAfterMonthOf:(NSDate *)dateB {
    NSDate *lastDate = [self lastDayOfMonth:dateB];

    if ([self date:dateA isAfter:lastDate]) {
        return YES;
    }
