...
- (void)switchToTextInputMode {
  ...
  HPLog(@"startRecordButton is :%@",self.startRecordButton);
...
- (void)drawRect:(CGRect)rect {
  ...
  [self setFrame:CGRectMake(0, kScreenHeight + g_statusBarHeight - 45, self.bounds.size.width, 45)];
  ...
  self.recordAnimationView=[[JCHATRecordAnimationView alloc]initWithFrame:CGRectMake((kScreenWidth-140)/2, (kScreenHeight -44.f - kTabBarHeight - 140)/2, 140, 140)];
...
- (void)addtoolbar {
  self.toolbar.frame = CGRectMake(0, 0, kScreenWidth, 45);
