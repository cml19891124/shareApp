...
@interface HPSearchResultViewController ()<SearchDelegate,HPSortSelectModalViewDelegate, HPLinkageViewDelegate, YYLRefreshNoDataViewDelegate>
...
- (void)viewDidLoad {
    ...
    _shareListParam.keywords = self.param[@"text"];
    
    _sorts = @[@"全部", @"店主", @"租客"];
    
    _navTitleView = [self setupNavigationBarWithTitle:@""];
    
    _dataArray = [NSMutableArray array];
    [self setUpStoreListUI];
    [self setUpStoreListUIMasonry];
