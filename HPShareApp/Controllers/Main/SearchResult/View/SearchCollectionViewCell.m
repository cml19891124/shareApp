...
- (UILabel *)wordLabel{
    if (!_wordLabel) {
        ...
        _wordLabel.font = kFont_Medium(12.f);
...
- (void)setSearchStr:(NSString *)searchStr{
    ...
    CGSize size = [_searchStr boundingRectWithSize:CGSizeMake(1000, 30) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName :kFont_Medium(12.f)} context:nil].size;
