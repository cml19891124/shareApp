...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.routeColor = COLOR_BLUE_0E78f6;//[UIColor blueColor];
        self.walkingColor = COLOR_RED_EA0000;//[UIColor cyanColor];
        self.railwayColor = COLOR_GREEN_EFF3F6;//[UIColor greenColor];
