...
@interface HPBaseNavViewController ()

@end

@implementation HPBaseNavViewController
...
- (void)pushVCByClassName:(NSString *)name withParam:(NSDictionary *)param {
    ...
    if (class) {
        ...
        if ([object isKindOfClass:HPBaseNavViewController.class]) {
            HPBaseNavViewController *baseVC = (HPBaseNavViewController *)object;
            baseVC = [baseVC init];
...
- (void)popWithParam:(NSDictionary *)param {
    ...
    if ([lastVC isKindOfClass:HPBaseNavViewController.class]) {
        HPBaseNavViewController *lastBaseVC = (HPBaseNavViewController *)lastVC;
        ...
        if ([tabBarController.selectedViewController isKindOfClass:HPBaseNavViewController.class]) {
            HPBaseNavViewController *lastBaseVC = (HPBaseNavViewController *)tabBarController.selectedViewController;
            lastBaseVC.isPop = YES;
