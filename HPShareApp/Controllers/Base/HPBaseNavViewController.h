...
@protocol HPBaseNavViewControllerDelegate  <NSObject>
...
@interface HPBaseNavViewController : UIViewController
...
@property (nonatomic, weak) id<HPBaseNavViewControllerDelegate> delegate;
